            ...
            <div style={{ padding: '28px' }}>
                ...
                <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
                    ...
                    <select
                        ...
                        className="form-input" style={{ width: 'auto', flex: 'none', paddingRight: '36px' }}
                    >
                ...
                <div style={{ display: 'flex', gap: '12px', marginBottom: '20px' }}>
                    {[
                        ...
                        { label: 'Active', value: '—', color: 'var(--color-success)' },
                        { label: 'This Month', value: '—', color: 'var(--color-info)' },
                    ].map(s => (
                                ...
                                {isLoading ? (
                                    ...
                                    students.map(s => (
                                        <tr key={s.id} className="animate-fadeIn">
                                            ...
                                            <td>
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                                    <div style={{
                                                        ...
                                                        background: 'var(--color-brand)', opacity: 0.8,
                                                        color: 'white', display: 'flex', alignItems: 'center',
                                                        justifyContent: 'center', fontSize: '0.8125rem', fontWeight: 700, flexShrink: 0,
                                                    }}>
                                            ...
                                            <td style={{ color: 'var(--color-text-secondary)' }}>{GENDER_MAP[s.gender ?? ''] ?? s.gender ?? '—'}</td>
                                            ...
                                            <td>
                                                <div style={{ display: 'flex', gap: '4px', justifyContent: 'flex-end' }}>
                                                    <button className="btn btn-ghost btn-sm" style={{ padding: '5px' }}><Eye size={14} /></button>
                                                    <button className="btn btn-ghost btn-sm" style={{ padding: '5px' }}><Edit size={14} /></button>
                                                </div>
                                            </td>
                                        </tr>
                                    ))
